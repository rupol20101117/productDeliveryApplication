      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Container(
                width: MediaQuery.sizeOf(context).width * 1.008,
                height: 734.0,
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          context.pushNamed(
                                            ...
                                            queryParameters: {
                                              'orderhistory': serializeParam(
                                                listViewOrdersRecord.productref,
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        '  ${listViewOrdersRecord.numberOfItemsInCart.toString()} - Items   (${formatNumber(
