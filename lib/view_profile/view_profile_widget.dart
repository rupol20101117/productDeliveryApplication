              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Image.network(
                                viewProfileUsersRecord.photoUrl,
                                fit: BoxFit.cover,
                              ),
                            ),
                          ),
                          Align(
                            ...
                            child: Text(
                              viewProfileUsersRecord.displayName,
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(30.0, 40.0, 20.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                20.0, 0.0, 0.0, 0.0),
                            child: Text(
                              viewProfileUsersRecord.address,
                              style: FlutterFlowTheme.of(context).titleMedium,
                            ),
                          ),
                        ],
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                20.0, 0.0, 0.0, 0.0),
                            child: Text(
                              viewProfileUsersRecord.phoneNumber,
                              style: FlutterFlowTheme.of(context).titleMedium,
                            ),
                          ),
                        ],
